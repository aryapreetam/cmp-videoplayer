...
This is your library's main package: `io.github.aryapreetam.cmpvideoplayer`
...
lib/src/
├── commonMain/kotlin/
│   ├── io/github/aryapreetam/cmpvideoplayer/          # Your library code (THIS DIRECTORY)
│   └── fiblib/                  # Example code (can be deleted)
└── commonTest/kotlin/
    ├── io/github/aryapreetam/cmpvideoplayer/          # Your tests
...
4. Write tests in `lib/src/commonTest/kotlin/io/github/aryapreetam/cmpvideoplayer/`
